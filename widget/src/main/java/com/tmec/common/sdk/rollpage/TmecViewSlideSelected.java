package com.tmec.common.sdk.rollpage;
...
public class TmecViewSlideSelected extends LinearLayout {
    private List<TmecViewSlideSelected.Circle> mCircleList = new ArrayList();
    ...
    public void showCurrentCircle(int current) {
        if (mCircleList.size() > current && current >= 0) {
            ...
            LinearLayout.LayoutParams currentLayoutParams = (LayoutParams) currentCircle.getLayoutParams();
            ...
            if (mRecordValue != current && recordCircle.isSelected()) {
                LinearLayout.LayoutParams recordLayoutParams = (LayoutParams) recordCircle.getLayoutParams();
    ...
    private void clearViewAndList() {
     ...
     static class Circle extends RadioButton implements SkinManager.OnSkinModeChangeListener {
