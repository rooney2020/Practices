package com.tsdl.practices.custom.grouphead;
...
public class TmecViewGroupHeader extends LinearLayout implements ISkinChangedListener {
    ...
    public void setItemCount(int count) {
        ...
        mRadioButtons.clear();
        int layoutHeight = TmecSkinConfigurationManager.getInstance().isNight()
