...
public class DropboxOutputManager {
    ...
    private final String outputPath = Environment.getExternalStorageDirectory().getPath() + "/log/dropbox.log";
    ...
    public static DropboxOutputManager getInstance(Context context) {
        mContext = context;
        if (sInstance == null) {
